About opentelemetry-exporter-otlp-proto-common-feedstock
========================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-exporter-otlp-proto-common-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-exporter-otlp-proto-common-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-exporter-otlp-proto-common
# for installing globally
pixi global install opentelemetry-exporter-otlp-proto-common
```
...
It is possible to list all of the versions of `opentelemetry-exporter-otlp-proto-common` available on your platform:
...
```
pixi search opentelemetry-exporter-otlp-proto-common --channel conda-forge
```
